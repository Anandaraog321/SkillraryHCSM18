...
public class WebDriverUtility {
	 ...
	 * @return
	 */
	public WebDriver launcgBrowser(String browser)
	{
		switch(browser) 
		{
	 ...
	 * @param element
	 */
	public void rightClick(WebElement element,WebElement dest)
	{
		Actions actions = new Actions(driver);
		actions.dragAndDrop(element, dest).perform();
	}
	...
	/**
	 * This method is used close all the tabs or windows 
	 */
